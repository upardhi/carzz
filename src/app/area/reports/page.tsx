  ...
  return (
    <>
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-2">
        ...
        <Card className="p-4">
          <CardHeading>Why washes were missed</CardHeading>
          <TableWrap>
            <Table>
              <thead>
                <tr>
              ...
              <tbody>
                {staff.map((row) => (
                  <tr key={row.staffId}>
                    ...
                    <Td
                      className={
                        row.onTimeRate < 0.7 ? 'font-bold text-danger-500' : ''
                      }
                    >
                    ...
                    <Td
                      className={
                        row.complaints > 5 ? 'font-bold text-danger-500' : ''
                      }
                    >
                      {row.complaints}
                    </Td>
        ...
        <Card className="p-4">
          ...
          {bestPerWash && worstPerWash && worstPerWash.perWash > bestPerWash.perWash * 1.2 ? (
            <div className="mt-3">
              <Note tone="danger">
                {worstPerWash.areaName} uses{' '}
                {Math.round(
                  (worstPerWash.perWash / bestPerWash.perWash - 1) * 100,
                )}
