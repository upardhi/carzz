...
export function BrandMark({
  ...
  return (
    <svg
      ...
      aria-hidden
    >
      <rect width="100" height="100" rx="22" fill="#16293a" />
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="50" cy="17" r="3.4" fill="#f0b429" />
      <path
        ...
        fill="#2cc0c0"
      />
      <path d="M45 55 L48 46 L61 46 L64 55 Z" fill="#12303f" opacity=".3" />
      <circle cx="31" cy="76" r="9" fill="#0b1a24" />
      <circle cx="31" cy="76" r="4.2" fill="#7fdede" />
      <circle cx="70" cy="76" r="9" fill="#0b1a24" />
      <circle cx="70" cy="76" r="4.2" fill="#7fdede" />
    </svg>
  );
}
