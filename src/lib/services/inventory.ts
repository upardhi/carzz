...
import type { Id, Rupees, StockLevel, StockRow } from '../data/types';
...
/** Drops every cached consumption entry — call after stock is issued, received, or an item's cost changes. */
export function invalidateConsumptionCache(): void {
