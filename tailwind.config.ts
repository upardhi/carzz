...
/**
 * Carz Management design tokens (FleetGuard palette).
 *
 * Deep blue navy + gold, not navy + teal:
 ...
 *   - success/warning/danger mark positive, caution and problem states
 *
